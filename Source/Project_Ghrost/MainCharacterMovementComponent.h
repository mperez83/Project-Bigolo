...
class PROJECT_GHROST_API UMainCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()

		friend class FSavedMove_Main;

#pragma region Defaults
private:
	// The ground speed when running
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Main Character Movement|Grounded", Meta = (AllowPrivateAccess = "true"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Main Character Movement|Wall Running", Meta = (AllowPrivateAccess = "true"))
		float LineTraceVerticalTolerance = 50.0f;
	// The player's velocity while wall running
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Main Character Movement|Wall Running", Meta = (AllowPrivateAccess = "true"))
		float WallRunSpeed = 625.0f;
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Main Character Movement|Other", Meta = (AllowPrivateAccess = "true"))
		float JumpForwardAddVelocity = 250.0f;
#pragma endregion

#pragma region Sprinting Functions
public:
	// Sets sprinting to either enabled or disabled
	UFUNCTION(BlueprintCallable, Category = "Main Character Movement")
